...
const smsUnreg = () => { return `\`\`\`¡𝙽𝙴𝙲𝙴𝚂𝙸𝚃𝙰𝚂 𝙴𝚂𝚃𝙰𝚁 𝚁𝙴𝙶𝙸𝚂𝚃𝚁𝙰𝙳𝙾(𝙰) 𝙿𝙰𝚁𝙰 𝚄𝚂𝙰𝚁 𝙴𝚂𝚃𝙴 𝙲𝙾𝙼𝙰𝙽𝙳𝙾, 𝙴𝚂𝙲𝚁𝙸𝙱𝙴 .reg1 nombre.edad 𝙿𝙰𝚁𝙰 𝚁𝙴𝙶𝙸𝚂𝚃𝚁𝙰𝚁𝚂𝙴!\`\`\`` }//VERIFICAR
...
//main.js
const smsWelcome = () => { return `〽️𝙷𝙾𝙻𝙰 @user 𝙱𝙸𝙴𝙽𝚅𝙴𝙽𝙸𝙳𝙾 𝙰 @group 〽️

👨🏻‍💻🏷𝙶𝚁𝙰𝙲𝙸𝙰𝚂 𝙿𝙾𝚁 𝚂𝙴𝚁 𝙿𝙰𝚁𝚃𝙴 𝙳𝙴 𝙴𝚂𝚃𝙰 𝙲𝙾𝙼𝚄𝙽𝙸𝙳𝙰𝙳, 𝙴𝚂𝚃𝙰𝙼𝙾𝚂 𝚁𝙴𝙰𝙻𝙼𝙴𝙽𝚃𝙴 𝙵𝙴𝙻𝙸𝙲𝙴𝚂 𝙿𝙾𝚁 𝙷𝙰𝙱𝙴𝚁𝚂𝙴 𝚄𝙽𝙸𝙳𝙾 𝙰𝙻 𝙶𝚁𝚄𝙿𝙾🫧

〽️𝙼𝙸𝚁𝙰 𝙽𝚄𝙴𝚂𝚃𝚁𝙾 𝚁𝙴𝙶𝙻𝙰𝙼𝙴𝙽𝚃𝙾
〽️𝚁𝙴𝙲𝚄𝙴𝚁𝙳𝙰 𝙲𝚄𝙼𝙿𝙻𝙸𝚁 𝙻𝙰𝚂 𝚁𝙴𝙶𝙻𝙰𝚂\n\`DESCRIPCION DEL GRUPO\`\n${String.fromCharCode(8206).repeat(850)}\n@desc `}
const smsBye = () => { return `¡ @user Se salio del grupo!\n\nNadie lo va a extrañar \n\nJAAJJAJA\n\nEl admin que escribio esto no tiene mensaje de salida asi que escribe huevadas\n\ngracias...`}
...
//_allantilink.js
const smsTextoYT = () => { return 'Bill-Bot '} 
...
const eGataCoins = () => { return 'BillCoins' }
